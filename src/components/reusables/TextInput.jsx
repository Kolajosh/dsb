    ...
    return (
      <div className={`${containerVariant}`}>
        ...
        <input
          ...
          type={type}
          className={` 
        focus:outline-none text-sm text-white border-[1.5px] border-[#8DA4EA] z-2 bg-[#ffffff] bg-opacity-10 ovtline-none placeholder:text-xs placeholder:text-[#939393] rounded-xl
        ${icon?.active && "px-12"} 
        ${
          isDisabled
